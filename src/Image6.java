...
public class Image6 {
	...
	throws IOException
	{
		...
		FileWriter fstream = new FileWriter("/Users/hal/Desktop/Mark/new/image6.txt");
...
//		System.out.println(logName);
		...
		while (prein.hasNextLine())
		{
			...
			if(kimage!=-1) {//there is the key word
                ...
                if(start==0){
                    if(Integer.valueOf(timePoint.substring(4))>Integer.valueOf(initialtime.substring(4))+1501234){
                   	 start=1;
                    }
                    }
                    
//                    if(Integer.valueOf(timePoint.substring(4))>Integer.valueOf(initialtime.substring(4))+901234){
...
//									if(robotNo==23){
//										print("begin "+timePoint+" "+convertime(timePoint));
//									}
								...
								//	print
									...
									if(robotNo==23){
										print("begin "+e.appearTime+" "+convertime(e.appearTime));
										print("end "+e.endTime+" "+convertime(e.endTime));
									}
