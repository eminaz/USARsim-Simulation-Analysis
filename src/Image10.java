...
public class Image10 {
	...
	throws IOException
	{
		...
		FileWriter fstream = new FileWriter("/Users/hal/Desktop/Mark/image10.txt");
...
//					print(timePoint);
                ...
                if(start==0){
                    if(Integer.valueOf(timePoint.substring(4))>Integer.valueOf(initialtime.substring(4))+1351234){
                   	 start=1;
                    }
                    }
