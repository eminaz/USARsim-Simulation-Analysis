...
//	public static void main()
	throws IOException
	{
		...
		FileWriter fstream = new FileWriter(run.dir+Image1.name+"Display to Marked.txt");
...
//				if(bool.equals("1")){		
				...
				if(oldtime!=""){
					...
					sr.write(oldtime+ " "+ time+" "+deltaTime+" "+(double)((double)deltaTime/1000.00)+" "+botNo+" "+bool);
					sr.newLine();

				}
				else{
					sr.write(-1+ " "+ time+" "+-1+" "+(double)((double)(-1)/1000.00)+" "+botNo+" "+bool);
					sr.newLine();
