...
public class Image7 {
	...
	throws IOException
	{
		...
		FileWriter fstream = new FileWriter("/Users/hal/Desktop/Mark/image7.txt");
...
//		System.out.println(logName);
	...
	//				print(timePoint);
                ...
                if(start==0){
                    ...
                    if(Integer.valueOf(timePoint.substring(4))>Integer.valueOf(initialtime.substring(4))+1051234){
